 ...
 */
package com.example.testwifi.screenrecorder;
...
import com.example.testwifi.screenrecorder.view.NamedSpinner;
...
public class MainTestActivity extends Activity {
    public static final String AUDIO_AAC=ScreenRecorder.AUDIO_AAC;
    public static final String VIDEO_AVC=ScreenRecorder.VIDEO_AVC;
...
//        mButton.setOnClickListener(this::onButtonClick);
        ...
        mAudioToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
...
//        mVideoCodec.setOnItemSelectedListener((view, position) -> onVideoCodecSelected(view.getSelectedItem()));
        mVideoCodec.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
...
//        mAudioCodec.setOnItemSelectedListener((view, position) -> onAudioCodecSelected(view.getSelectedItem()));
        mAudioCodec.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
...
//        });
        mVieoResolution.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
...
//        });
        mVideoFramerate.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
...
//        });
        mVideoBitrate.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
                onFramerateChanged(position, (String) view.getSelectedItem());
...
//        });
        mOrientation.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
    ...
    private void resetSampleRateAdapter(MediaCodecInfo.CodecCapabilities capabilities) {
        ...
        if (old == null || !(old instanceof ArrayAdapter)) {
            ...
            ArrayAdapter<Integer> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, l);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private String getSelectedAudioCodec() {
        return mAudioCodec == null ? null : (String) mAudioCodec.getSelectedItem();
    }
...
//            MediaCodecInfo.VideoCapabilities videoCaps = caps.getVideoCapabilities();
            MediaCodecInfo.VideoCapabilities videoCaps =null;
            if (videoCaps != null) {
                builder.append("\n  Video capabilities:")
...
//                    MediaCodecInfo.CodecProfileLevel[] levels = caps.profileLevels;
                    MediaCodecInfo.CodecProfileLevel[] levels =null;
                    builder.append("\n  Profile-levels: ");
...
//            MediaCodecInfo.AudioCapabilities audioCaps = caps.getAudioCapabilities();
            MediaCodecInfo.AudioCapabilities audioCaps =null;
            if (audioCaps != null) {
                builder.append("\n Audio capabilities:")
