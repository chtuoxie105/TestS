package android.materialdesignlibrary.materialrefreshlayout;

import android.content.Context;
import android.content.res.TypedArray;
import android.graphics.Color;
import android.materialdesignlibrary.R;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (isSunStyle) {
            ...
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dip2px(context, hIGHER_HEAD_HEIGHT));
            layoutParams.gravity = Gravity.TOP;
            if (headerViewTopMargin != 0) {
                layoutParams.topMargin = headerViewTopMargin;
            }
    ...
    public void setHeaderViewTopMargin(int headerViewTopMargin) {
        this.headerViewTopMargin = headerViewTopMargin;
    }
