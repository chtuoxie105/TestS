package android.materialdesignlibrary;
...
public class LoadingButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, android.materialdesignlibrary.R.styleable.LoadingButton, 0, 0);
            mColorPrimary = ta.getInt(android.materialdesignlibrary.R.styleable.LoadingButton_lb_btnColor, defaultColor);
            String text = ta.getString(android.materialdesignlibrary.R.styleable.LoadingButton_lb_btnText);
            mText = text == null ? "" : text;
            mTextColor = ta.getColor(android.materialdesignlibrary.R.styleable.LoadingButton_lb_textColor, Color.WHITE);
            resetAfterFailed = ta.getBoolean(android.materialdesignlibrary.R.styleable.LoadingButton_lb_resetAfterFailed, true);
            mRippleColor = ta.getColor(android.materialdesignlibrary.R.styleable.LoadingButton_lb_btnRippleColor, Color.BLACK);
            mRippleAlpha = ta.getFloat(android.materialdesignlibrary.R.styleable.LoadingButton_lb_btnRippleAlpha, 0.3f);
            ta.recycle();
        }
