package com.imagepickerlibrary.widget;
...
public class PickerBottomLayout extends FrameLayout {
    ...
    private int pickTextRes = R.string.imagepicker_general_send;
    ...
    public void updateSelectedSize(String size) {
        if (TextUtils.isEmpty(size)) {
            ...
            originalContainer.setVisibility(View.VISIBLE);
            originalSize.setText(getResources().getString(R.string.imagepicker_general_original) + " "
                    + getResources().getString(R.string.imagepicker_bracket_str, size));
        }
    }
