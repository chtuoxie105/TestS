...
import com.imagepickerlibrary.activity.CropImageActivity;
import com.imagepickerlibrary.activity.PhotoPickerActivity;
...
public class SImagePicker {
    ...
    private
    @StringRes
    int pickRes = R.string.imagepicker_general_send;
